export function html({ url, host, email }) {
  ...
  return `
    ...
    <h2 style="text-align: center; text-transform: uppercase;color: teal;">BIENVENYE</h2>
    
    <h3 style="text-align: center; text-transform: uppercase;">${escapedHost}</h3>
    
    <p>Congratulations! 
      Sign in  <strong>${escapedEmail}</strong>.
    </p>
    ...
    <p>SI si le bouton n'est pas fonctionel appuier ici</p>
